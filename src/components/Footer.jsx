    ...
    <footer className="site-footer">
      <div className="container">
        <div className="footer-inner">
          <div>
            <div className="footer-brand">Alexis Obi</div>
            <p className="footer-text">Documenting life, style, and the intersection of creativity and technology.</p>
          </div>
          <div>
            ...
            <div className="footer-links">
              ...
              <Link to="/portfolio">Portfolio & Services</Link>
          ...
          <address>
            ...
            <div className="footer-links">
              ...
              <a href="https://www.instagram.com/alexisobii" target="_blank" rel="noopener noreferrer">Instagram</a>
              <a href="https://www.linkedin.com/in/alexisobionIn" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            </div>
          </address>
        </div>
        <div className="footer-bottom">
          <span>&copy; {new Date().getFullYear()} Alexis Obi. All rights reserved.</span>
